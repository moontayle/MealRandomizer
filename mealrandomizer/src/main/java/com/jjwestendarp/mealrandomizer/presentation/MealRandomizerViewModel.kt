...
class MealRandomizerViewModel(
    ...
    fun shuffleMeals() {
        ...
        shuffledList.forEach {
            ...
            if (TimeUnit.MILLISECONDS.toDays(difference) >= 0) { //TODO: Need a settings value to track the number of days since last use as well as a way to simply reset that value
